...
(function() {
  ...
  // SCENE =========================================
  var containerField = document.querySelector('.image2-field');
  // var WIDTH = window.innerWidth,
  //     HEIGHT = window.innerHeight;
  var WIDTH = containerField.clientWidth/2,
      HEIGHT = containerField.clientWidth/2;
  ...
  // var container = document.getElementsByClassName('image1');
  var container = document.querySelector('.formbuilder-image2');
  var container3 = document.querySelector('.formbuilder-image3');
